...
object DeviceUtils {
    ...
    fun getAndroidID(): String {
        return Settings.Secure.getString(Utils.instance.context.contentResolver, Settings.Secure.ANDROID_ID)
    }
    ...
    private fun getMacAddressByWifiInfo(): String {
        try {
            val wifi = Utils.instance.context.getSystemService(Context.WIFI_SERVICE) as WifiManager
    ...
    private fun getMacAddressByFile(): String {
        ...
        if (result.result == 0) {
            ...
            if (name != null) {
                ...
                if (result.result == 0 && !result.successMsg.isNullOrBlank()) {
    ...
    fun shutdown() {
        ...
        Utils.instance.context.startActivity(intent)
    }
    ...
    fun reboot() {
        ...
        Utils.instance.context.sendBroadcast(intent)
    }
    ...
    fun reboot(reason: String) {
        val mPowerManager = Utils.instance.context.getSystemService(Context.POWER_SERVICE) as PowerManager
        try {
