...
import com.lib.utils.android.view.StatusBarView
...
object BarUtils {
    ...
    fun setColor(activity: Activity, color: Int, statusBarAlpha: Int = 0) {
     ...
     */
    @JvmOverloads
    fun setColorForSwipeBack(activity: Activity, color: Int, statusBarAlpha: Int = DEFAULT_STATUS_BAR_ALPHA) {
